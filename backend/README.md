...
Python **3.14** (see [`.python-version`](.python-version); use `uv python pin 3.14` after cloning). Managed interpreters: [uv Python installs](https://docs.astral.sh/uv/concepts/python-versions/).
